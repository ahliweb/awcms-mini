...
/** `GET /api/v1/domain-events/deliveries/{id}` (Issue #742) — includes the joined event with a redacted payload projection. This is the DLQ single-record inspection view when the delivery's `status` is `dead_letter`. */
