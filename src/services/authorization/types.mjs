...
function normalizeAuthorizationSubject(input = {}) {
  return {
    ...
    current_job_id: normalizeNullableString(input.current_job_id),
    current_job_level_id: normalizeNullableString(input.current_job_level_id),
    current_job_title_id: normalizeNullableString(input.current_job_title_id),
    supervisor_user_id: normalizeNullableString(input.supervisor_user_id),
