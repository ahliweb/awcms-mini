...
**Semantic Versioning** + **[Changesets](.changeset/README.md)**; riwayat di [`CHANGELOG.md`](CHANGELOG.md). Setiap PR yang mengubah perilaku wajib menyertakan changeset. Versi saat ini `0.16.0` — **seluruh 18 issue backlog base generik (doc06) tuntas**: foundation + epic M2 (tenant/office, central profile, identity/login, RBAC/ABAC) + 12.1 setup wizard + epic M5 Sync Storage (6.1-6.3) + epic M7 UI/UX & Reporting (8.1, 9.1) + epic M8 Security/Performance/Production (10.1 structured logging & audit trail, 10.2 database connection pooling & backpressure, 10.3 production security readiness, 11.1 workflow approval engine, 12.2 offline/LAN deployment profile).
