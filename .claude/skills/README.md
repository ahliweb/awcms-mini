...
| `awcms-mini-tenant-provisioning`                       | Kerjakan bagian mana pun modul tenant_provisioning — provisioning tenant idempoten/resumable, plan/step registry berversi, lease/checkpoint/bounded-retry, kompensasi diklasifikasi (reversible/manual/forbidden), reconciliation non-destruktif, readiness (Issue #872)                                                                                            | tenant-provisioning/README.md, tenant-provisioning/SKILL.md       |
...
| `awcms-mini-tenant-lifecycle`                          | Kerjakan bagian mana pun modul tenant_lifecycle — state machine lifecycle tenant, restriksi fail-closed server-derived lintas API/SSR/public/worker, transisi terjadwal idempoten, downgrade non-destruktif, restore ter-rekonsiliasi (Issue #873)                                                                                                                  | tenant-lifecycle/README.md, tenant-lifecycle/SKILL.md             |
| `awcms-mini-subscription-billing`                      | Kerjakan bagian mana pun modul subscription_billing — state komersial SaaS (subscription/invoice/credit/dunning), uang EXACT minor-unit bigint, single-currency, issued invoice immutable (koreksi via credit-note/void), generasi invoice idempoten per period, dunning via kontrak lifecycle #873 fail-closed; BUKAN general ledger/AR-AP/tax engine (Issue #876) | subscription-billing/README.md, subscription-billing/SKILL.md     |
