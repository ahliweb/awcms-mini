...
2. Import mentah ke schema **`legacy`** terpisah — jangan langsung ke tabel `awcms_*`.
3. Semua run tercatat di `awcms_legacy_migration_runs` (+ mappings, row counts, validation errors, backfill tasks).
