...
Endpoint mutation high-risk base (setup initialize, resolve, link, merge, assignment, workflow decision, sync push — plus daftar aplikasi domain) **wajib** idempotency.
