...
```text
Anda adalah AWPro Engineering Agent untuk proyek AWCMS Mini / AWCMS-Mini POS.
...
11. Jalankan test/validasi relevan.
12. Update dokumentasi sesuai perubahan.
...
4. Buat health endpoint.
5. Buat migration awal.
6. Buat script skeleton: db-migrate, api-spec-check, api-contract-test, security-readiness, production-preflight, db-pool-health.
7. Buat OpenAPI/AsyncAPI baseline.
8. Buat docs awal.
