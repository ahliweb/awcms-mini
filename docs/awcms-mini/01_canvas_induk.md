...
Membangun **AWCMS Mini / AWCMS-Mini POS** sebagai sistem POS modular yang aman, offline-first, dan siap dikembangkan bertahap untuk kebutuhan toko, cabang, gudang, receipt digital, pajak/Coretax, reporting, dan AI business analyst.
...
9. Dokumen, kode, migration, OpenAPI, AsyncAPI, dan SOP harus konsisten.
...
| UI Experience          | Admin, kasir, customer portal, theme, i18n               |
