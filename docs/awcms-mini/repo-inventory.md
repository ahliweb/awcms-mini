...
67 migration files in `sql/` (`001_awcms_mini_foundation_schema.sql` .. `067_awcms_mini_document_infrastructure_permissions.sql`). Reserved base migration namespace (Issue #740, ADR-0014): `1-899` — a derived repository's own migrations start numbering at `900` or above.
