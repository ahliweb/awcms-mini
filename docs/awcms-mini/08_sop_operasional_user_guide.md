...
Dokumen ini menjadi panduan operasional AWCMS Mini untuk admin, owner, kasir, petugas gudang, tax officer, CRM staff, customer, dan admin teknis.
...
8. Backup harus diuji restore.
9. POS dapat berjalan offline.
10. Sync berjalan saat koneksi tersedia.
...
1. Login kasir.
2. Buka POS.
3. Pastikan tenant/office/kasir benar.
4. Scan/cari produk.
