...
Folder ini berisi paket dokumen master untuk pengembangan **AWCMS Mini / AWCMS-Mini POS Modular Monolith**.
...
## AWCMS Mini sebagai contoh pengembangan berbasis AWCMS-Mini

AWCMS Mini dibangun di atas base **AWCMS-Mini** dan sengaja disusun agar bisa dipakai sebagai **template/contoh** untuk mengembangkan aplikasi lain di atas base yang sama. Bagian yang **generik & reusable** (pola AWCMS-Mini) vs **spesifik domain AWCMS Mini**:

| Reusable (pola AWCMS-Mini)                           | Spesifik domain (AWCMS Mini)         |
| ---------------------------------------------------- | ------------------------------------ |
| Struktur modular monolith + module contract (10, 11) | Modul POS/warehouse/tax/CRM (02, 03) |
| Baseline keamanan RBAC + ABAC + RLS + audit (16, 17) | Matriks role & policy POS (17)       |
| Konvensi migration, OpenAPI, AsyncAPI (04, 05, 16)   | Schema & endpoint domain (04, 05)    |
| Design system & shell UI (14, 15)                    | Layar POS/kasir/portal (14)          |
| Offline-first (service worker + outbox) (15, 16)     | Alur transaksi kasir (08)            |
