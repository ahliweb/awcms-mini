...
| Istilah                           | Definisi                                                                                                                          |
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **AWCMS Mini**                    | AWCMS-Mini POS — aplikasi POS modular yang dirancang paket dokumen ini.                                                           |
...
| Istilah                            | Definisi                                                                     |
| ---------------------------------- | ---------------------------------------------------------------------------- |
| **Checkout session**               | Draft transaksi kasir sebelum diposting (status draft/held).                 |
