...
| **Audit log** | Catatan aksi high-risk untuk akuntabilitas (`awcms-mini_audit_events`). |
...
| **Idempotency store** | `awcms-mini_idempotency_keys` — penyimpanan hasil mutation high-risk. |
