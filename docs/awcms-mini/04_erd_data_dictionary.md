...
### Data Lifecycle (Issue #745, epic #738 platform-evolution, `sql/056`–`057`)
...
Skema inti (`056_awcms_mini_data_lifecycle_schema.sql`, semua
...
(`057_awcms_mini_data_lifecycle_permissions.sql`) — `registry.read`,
