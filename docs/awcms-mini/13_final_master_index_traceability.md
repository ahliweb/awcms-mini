...
|    ADR | `../adr/README.md`                                                                                                  | Architecture Decision Records (keputusan base + alasan) — termasuk `../adr/0013-extension-layers-and-boundary-model.md` (Issue #739, epic #738 `platform-evolution`; **di-supersede [ADR-0024](../adr/0024-awcms-family-direct-use-templates-and-derived-pathway-removal.md)**): lapisan ekstensi Core/System Foundation/Official Optional Business Foundation/SaaS Control Plane/ERP Extension/Derived Application, batas tenant vs legal entity vs organization unit, data-ownership matrix, dan kriteria evidence-based ekstraksi layanan; `../adr/0014-deterministic-build-time-module-composition.md` (Issue #740, epic #738; **di-supersede [ADR-0024](../adr/0024-awcms-family-direct-use-templates-and-derived-pathway-removal.md)**): titik ekstensi `application-registry.ts`, taksonomi kegagalan komposisi, dan konvensi namespace migration; dan `../adr/0020-erp-extension-readiness-contracts.md` (Issue #755, epic #738 Wave 4; di-amend ADR-0024): kontrak business transaction/posting/period-lock/item/currency/UoM/inventory-movement/reconciliation/report-projection untuk ekstensi ERP, tanpa modul/tabel ERP baru di base; `../adr/0024-awcms-family-direct-use-templates-and-derived-pathway-removal.md` (ADR-0024, men-supersede 0013/0014/0015 & meng-amend 0012/0020): keluarga AWCMS dipakai-LANGSUNG, modul domain ditambahkan langsung di `src/modules/` template yang dipakai (jalur aplikasi-turunan `application-registry.ts`/`extension:check`/namespace migration turunan DIHAPUS), validasi via `modules:compose:check` |
...
Aplikasi domain (mis. AWPOS) menambahkan modulnya sendiri **langsung** di
`src/modules/` template ini/fork yang dipakai (ADR-0024, men-supersede
jalur turunan #740), divalidasi `bun run modules:compose:check`: master
produk & stok, transaksi/checkout POS, shared stock routing, multi gudang,
receipt digital + WA/email, pajak/Coretax, dan AI business analyst.
...
| Modul (`key`)                | Migration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| _(Foundation, lintas-modul)_ | `001_awcms_mini_foundation_schema.sql`, `013_awcms_mini_enforce_rls_least_privilege.sql`, `045_awcms_mini_db_role_separation.sql`, `077_awcms_mini_performance_missing_indexes.sql`, `101_awcms_mini_control_plane_projection_sources.sql`, `103_awcms_mini_control_plane_fleet_sweep_grants.sql`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `service_catalog`            | `079_awcms_mini_service_catalog_schema.sql`, `080_awcms_mini_service_catalog_permissions.sql` (Issue #870, epic #868 SaaS control plane Wave 1, ADR-0022), `097_awcms_mini_service_catalog_commercial_approval.sql` (Issue #879, epic #868 Wave 2, ADR-0022 §5 HIGH-2 — publish vs commercial-approval maker/checker)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `tenant_entitlement`         | `081_awcms_mini_tenant_entitlement_schema.sql`, `082_awcms_mini_tenant_entitlement_permissions.sql` (Issue #871, epic #868 SaaS control plane Wave 1, ADR-0022), `104_awcms_mini_tenant_entitlement_expiry.sql` (Issue #930 — status `expired` + expiry sweep grants)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `tenant_provisioning`        | `085_awcms_mini_tenant_provisioning_schema.sql`, `086_awcms_mini_tenant_provisioning_permissions.sql` (Issue #872, epic #868 SaaS control plane Wave 1, ADR-0022), `105_awcms_mini_control_plane_reconciliation_grants.sql` (Issue #930 — worker grants for the fleet-wide reconciliation pass)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `usage_metering`             | `087_awcms_mini_usage_metering_schema.sql`, `088_awcms_mini_usage_metering_permissions.sql` (Issue #875, epic #868 SaaS control plane Wave 1, ADR-0022), `099_awcms_mini_usage_metering_safe_watermark_cursor.sql` (Issue #900 — commit-order `xid8` safe-watermark cursor closing the commit-reorder under-count hazard), `100_awcms_mini_usage_metering_stale_watermark_index.sql` (Issue #901 — `ingest_seq`-extended window index for the bounded quota recompute's index-only settled-staleness probe)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `subscription_billing`       | `091_awcms_mini_subscription_billing_schema.sql`, `092_awcms_mini_subscription_billing_permissions.sql` (Issue #876, epic #868 SaaS control plane Wave 1, ADR-0022), `096_awcms_mini_subscription_billing_credit_approval.sql` (Issue #879, epic #868 Wave 2, ADR-0022 §5 — credit-note create vs approve maker/checker)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `payment_gateway`            | `093_awcms_mini_payment_gateway_schema.sql`, `094_awcms_mini_payment_gateway_permissions.sql` (Issue #877, epic #868 SaaS control plane Wave 1, ADR-0022), `095_awcms_mini_payment_gateway_refund_approval.sql` (Issue #879, epic #868 Wave 2, ADR-0022 §5 CRITICAL-1 — refund request vs approve maker/checker, money-out only after a distinct approver), `102_awcms_mini_payment_gateway_retention.sql` (Issue #932, epic #868 — mempersempit empat trigger append-only dari `BEFORE UPDATE OR DELETE` ke `BEFORE UPDATE` sehingga bukti webhook bisa menua; proteksi UPDATE tidak berubah, batas DELETE pindah ke grant `awcms_mini_worker` mengikuti pola `usage_metering` migration 087, plus index retensi dan index FK anak), `106_awcms_mini_payment_gateway_outbox_retention.sql` (Issue #930 Wave 5 — outbox ikut bisa dipurge: trigger `no_delete` DIHAPUS (hanya menjaga DELETE, jadi tak ada yang tersisa untuk dipersempit) dan batasnya pindah ke grant, plus index retensi PARSIAL pada status terminal saja) |

Enam migration di baris "Foundation, lintas-modul" tidak dipetakan ke
...
diatribusikan ke satu pemilik. `101` (Issue #880, epic #868 Wave 3) sama
sifatnya: murni GRANT + index untuk lima tabel sumber milik lima modul
control-plane berbeda plus `awcms_mini_tenant_modules`, agar worker
`reporting:projections:refresh` yang least-privilege bisa membaca sumber
proyeksi yang baru dideklarasikan tiap modul — tidak mengubah schema modul
mana pun. `103` (Issue #930, epic #868) mengikuti pola `101` persis: murni
GRANT SELECT + index untuk empat tabel milik tiga modul control-plane
(`tenant_provisioning`, `tenant_entitlement`, `subscription_billing`), agar
worker `control-plane:fleet-sweep` yang least-privilege bisa membaca sinyal
operasional fleet-wide. Read-only, tanpa perubahan schema, tanpa policy baru
— isolasi tenant tetap lewat RLS per-tenant seperti sebelumnya.
