...
AWCMS Mini adalah POS modular berbasis AWCMS-Mini dengan stack final:
...
| Transaksi kasir          | Sales POS             | Checkout, payment, sales document |
...
| UI admin/kasir           | UI Experience         | Admin shell, POS screen           |
...
| Modul                 | Migration                                                   |
| --------------------- | ----------------------------------------------------------- |
| Foundation            | `001_awcms_foundation_schema.sql`                           |
| Tenant Admin          | `002_awcms_tenant_identity_schema.sql`                      |
| Catalog Inventory     | `003_awcms_catalog_inventory_schema.sql`                    |
| Sales POS             | `004_awcms_sales_pos_schema.sql`                            |
| Sync Storage          | `005_awcms_sync_storage_r2_schema.sql`                      |
| CRM                   | `006_awcms_crm_receipt_communication_schema.sql`            |
| Accounting Tax        | `007_awcms_accounting_tax_coretax_schema.sql`               |
| AI                    | `008_awcms_ai_hermes_business_analyst_schema.sql`           |
| i18n                  | `009_awcms_i18n_po_schema.sql`                              |
| Theme                 | `010_awcms_theme_mode_schema.sql`                           |
| ABAC                  | `011_awcms_abac_access_control_schema.sql`                  |
| Contracts             | `012_awcms_modular_monolith_contracts_schema.sql`           |
| Logging               | `013_awcms_logging_observability_schema.sql`                |
| Profile               | `014_awcms_central_profile_management_schema.sql`           |
| Profile Stabilization | `015_awcms_profile_stabilization_schema.sql`                |
| Workflow              | `016_awcms_workflow_approval_audit_schema.sql`              |
| Reporting             | `017_awcms_management_dashboard_reporting_schema.sql`       |
| Legacy Migration      | `018_awcms_legacy_migration_backfill_toolkit_schema.sql`    |
| Performance Sync      | `019_awcms_performance_sync_validation_schema.sql`          |
| Production Security   | `020_awcms_production_security_readiness_schema.sql`        |
| DB Pooling            | `021_awcms_database_connection_pooling_schema.sql`          |
| UI Experience         | `022_awcms_ui_ux_persona_experience_schema.sql`             |
| Warehouse             | `023_awcms_warehouse_management_schema.sql`                 |
| Idempotency           | `024_awcms_transaction_integrity_idempotency_hardening.sql` |
| Setup Wizard          | `025_awcms_setup_wizard_extension.sql`                      |
| Dashboard Views       | `026_awcms_dashboard_materialized_views.sql`                |
...
- POS tidak aman tanpa tenant/auth/profile/access.
...
Semua file `docs/awcms-mini/01` sampai `19` harus menjadi acuan sebelum coding. Dokumen `14`–`18` (UI/UX, frontend, backend/DB, seed/RBAC/ABAC, konfigurasi) melengkapi kesiapan implementasi; `19` adalah glossary rujukan istilah.
...
flowchart TB
  ...
  ERD --> API[OpenAPI/AsyncAPI] --> ISS[GitHub Issues] --> SPR[Sprint Plan]
