...
- The setup/runtime safety seam is now owned by the linked compatibility checkout; Mini validates drift with `bun run check:emdash-drift` instead of carrying a separate host-routing fork.
