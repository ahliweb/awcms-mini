...
- EmDash `0.9.0` remains the current reviewed package baseline and canonical host architecture.
...
- `README.md` now reflects the current EmDash `0.9.0` baseline, Cloudflare-plus-Hono deployment posture, and Coolify locked-secret guidance.
